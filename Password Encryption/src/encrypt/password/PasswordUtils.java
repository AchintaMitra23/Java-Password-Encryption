...
// This class used to encrypt and varify user password... 
public class PasswordUtils {
	...
	public static String generateSecurePassword(String password, String salt) {
		...
		returnValue = Base64.getEncoder().encodeToString(securePass);
		return returnValue;
	}
	
	public static boolean varifyUserPassword(String providedPassword, String securedPassword, String salt) {
		boolean returnValue = false;
		String newSecurePass = generateSecurePassword(providedPassword, salt);
		returnValue = newSecurePass.equalsIgnoreCase(securedPassword);
		return returnValue;
	}
